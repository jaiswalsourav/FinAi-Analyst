export default function CreateUserPage(
    { newUserName, newUserEmail, newUserPassword, confirmPassword, setNewUserName, setNewUserEmail, 
        setNewUserPassword, setConfirmPassword, error, message, onCreateUser, onBack }) {
  return (
    <div className="login-card">
      <div className="brand"><div className="brand-badge">FA</div><div><h1 style={{ margin: 0 }}>Create Account</h1><p style={{ margin: '4px 0 0', color: '#1dac2e' }}>Create a new user account.</p></div></div>
